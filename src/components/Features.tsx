...
const FEATURES = [
  { title: 'Start with a conversation, not a spec.', em: 'conversation', description: 'Describe what you want to accomplish. Twin helps you brainstorm, refine, and turn vague ideas into working agents.' },
  { title: 'Connects to any API, built on the fly.', em: 'fly', description: 'Twin creates integrations in real time. If the API exists, Twin is already integrated.' },
  { title: "When there's no API, it uses the browser.", em: 'browser', description: 'Your agent can log in, click, scroll, and extract data like a human would.' },
  { title: 'Deploy once, run forever.', em: 'forever', description: 'Set your agent to run on a schedule or trigger it from webhooks, emails, or messages.' },
  { title: 'Share with the community.', em: 'community', description: 'Publish your agents for others to use. Discover what others have built.' },
]
